...
<template>
  <div class="p-4 space-y-6">
    ...
    <main class="max-w-4xl mx-auto space-y-6">
      <section>
        <p class="mt-4">
          At <strong>PomoDuck</strong>, we value your privacy. This Privacy Policy explains how we collect, use, and
      ...
      <section>
        ...
        <ul class="list-disc list-inside mt-2 space-y-2">
          ...
          <li>Data shared via third-party logins such as Google, Twitter, or Telegram</li>
        </ul>
      </section>
